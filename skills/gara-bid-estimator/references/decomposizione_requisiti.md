...
- **Esempio**:
  ...
  REQ-001.1 | Portale e Frontend | Area pubblica — consultazione servizi      | Schermate: ... | React | Media | 7 | 3 | 2 | 12 | Must Have | ...
  REQ-001.2 | Portale e Frontend | Area riservata cittadino — gestione pratiche| Schermate: ... | React | Alta  | 14| 8 | 3 | 25 | Must Have | ...
  REQ-001.3 | Portale e Frontend | Area operatore — istruttoria e approvazione | Schermate: ... | React | Alta  | 12| 7 | 2 | 21 | Must Have | ...
  ```
...
- **Esempio**:
  ...
  REQ-008.1 | Autenticazione & IAM | Schermate autenticazione — login, MFA, recupero pwd | Schermate: login (form), MFA (wizard)... | React    | Alta  | 4 | 0 | 0 |  4 | Must Have | ...
  REQ-008.2 | Autenticazione & IAM | API autenticazione e token management               | API: POST /auth/token, POST /auth/refresh... | Keycloak | Alta  | 0 | 8 | 1 |  9 | Must Have | ...
  REQ-008.3 | Autenticazione & IAM | Gestione profili, RBAC e audit trail                | API: GET/PUT /utenti/{id}/ruoli, GET /audit... | Keycloak | Alta  | 1 | 5 | 2 |  8 | Must Have | ...
  ```
